<?php
	...
	----------*/
	const SERVERURL="https://laferiadeldisco.azurewebsites.net/La_feria_del_disco-main";


	/*----------  
	Nombre de la empresa o compañia -  Company or company name
	----------*/
	const COMPANY="La feria del disco";
	...
	const FACEBOOK="https://www.facebook.com/LaFeriaDelDisco/";
	const INSTAGRAM="";
	const YOUTUBE="https://www.youtube.com/c/LaFeriaDelDisco";
	const TWITTER="";


	/*----------  Direccion - Address  ----------*/
	const COUNTRY="Colombia";
	const ADDRESS="Florencia, Caqueta, Colombia";
	...
	const DOCUMENTS_USERS=["TI","Cedula","Pasaporte","Otro"];
	const DOCUMENTS_COMPANY=["Cedula","RUT","NIT","Otro"];


	/*----------  Tipos de unidades de productos - Types of product units ----------*/
	const PRODUTS_UNITS=["Unidad","Caja","Paquete","Otro"];
